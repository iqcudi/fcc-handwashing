var app = (function () {
    ...
    /* src\Hto.svelte generated by Svelte v3.37.0 */
    ...
    class Hto extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    /* src\Nav.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div1, "class", "ring ring-red-900 ring-offset-1 ring-offset-red-900 rounded progress-container svelte-1d0jtwa");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			mount_component(hto, target, anchor);
    		...
    		i(local) {
    			...
    			transition_in(hto.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(nav.$$.fragment, local);
    			transition_out(timer.$$.fragment, local);
    			transition_out(hto.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			...
    			destroy_component(hto, detaching);
